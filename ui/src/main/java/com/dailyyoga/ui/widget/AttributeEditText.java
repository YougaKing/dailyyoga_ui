...
public class AttributeEditText extends AppCompatEditText {
    ...
    public AttributeEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AttributeEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AttributeEditText);
